...
//DBE001 ==>search didn't work
        ...
        if ($send_mail == true) {
            ...
            // $message = "Hello";
            $from = "info@students.oauife.edu.ng";
            $headers = "From:" . $from;
...
<br/>1.    Click <a href="http://Google.com/a/students.oauife.edu.ng" target="_blank">HERE</a> to access your Google apps account with the details above.
